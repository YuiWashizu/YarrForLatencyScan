...
// Wed Mar  6 14:12:06 2019 by ROOT version 6.10/02
// from TTree HitTree/Hit Tree
// found on file: rootfile.root
//////////////////////////////////////////////////////////

#ifndef fromHitTree_h
#define fromHitTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           hit_bcid;
   Int_t           hit_l1id;
   Int_t           hit_col[19];   //[nhits]
   Int_t           hit_row[19];   //[nhits]
   Int_t           hit_tot[19];   //[nhits]
   Int_t           pixel_cluster_id[19];   //[nhits]
   Int_t           nclusters;
   Int_t           cluster_tot[19];   //[nclusters]
   Int_t           cluster_id[19];   //[nclusters]
   Int_t           cluster_size[19];   //[nclusters]
   Int_t           cluster_ncol[19];   //[nclusters]
   Int_t           cluster_nrow[19];   //[nclusters]
...
#ifdef fromHitTree_cxx
fromHitTree::fromHitTree(TTree *tree) : fChain(0) 
{
...
fromHitTree::~fromHitTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fromHitTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fromHitTree::LoadTree(Long64_t entry)
{
...
void fromHitTree::Init(TTree *tree)
{
...
void fromHitTree::Show(Long64_t entry)
{
...
Int_t fromHitTree::Cut(Long64_t entry)
{
